...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/about_style.css" />
		<!--***sermon***-->
	<link rel="stylesheet" type="text/css" href="css/sermon_style.css" />
	<style>
		#map_canvas {
	       width: 500px;
	       height: 400px;
	...
	<link rel='stylesheet' href='css/fullcalendar.jquery-ui.min' />
	...
	<script type="text/javascript" src="scriptjs/jquery-1.9.1.min.js"></script>
