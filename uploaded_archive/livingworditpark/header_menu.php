<div id="header">
    ...
    <?php
    	...
    	if (isset($user) && $basename == 'welcome')
			echo "<div id='greeting'>Hello, $user!</div>";
		else
		{
			echo "<div id='links'>"
    ...
    <div id="navmenu">
        <nav id="menu">
            <ul>
                ...
                <li <?php echo $menu_id == 'about' ? "class='active'" : ""; ?>><a href="about.php" title="know more about us">About Us</a>
                    <ul class="menu_about">
                ...
                <li <?php echo $menu_id == 'schedule' ? "class='active'" : ""; ?>><a href="schedule.php">Schedule/Events</a></li>
                <li <?php echo $menu_id == 'involve' ? "class='active'" : ""; ?>><a href="">Get Involved</a>
                    <ul>
                        ...
                        <li><a href="#"><span class="icon activities"></span>Activities</a></li>
                ...
                <li <?php echo $menu_id == 'resources' ? "class='active'" : ""; ?>><a href="#">Resources</a>
                    <ul>
                        <li><a href="#" title="listen or download recorded audio sermon"><span class="icon audio"></span>Audio Sermon</a></li>
                ...
                <li <?php echo $menu_id == 'admin' ? "class='active'" : ""; ?>><a href="#">Admin</a>
                	<ul>
                        ...
                        <li><a href="sermon.php"><span class="icon audio_upload"></span>Upload Sermon</a></li>
